...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button type="button" class="btn btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#addBarangModal">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-secondary">{{ $item->merk ?? '-' }}</td>
                        <td>
...
<div class="modal fade" id="addBarangModal" tabindex="-1" aria-labelledby="addBarangModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            <form method="POST" action="{{ route('admin.barang.store') }}" id="formTambahBarang">
                @csrf
                <div class="modal-header bg-primary text-white rounded-top-4 border-0">
                    <h5 class="fw-bold mb-0" id="addBarangModalLabel">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="tahun_perolehan" class="form-control rounded-3" placeholder="Contoh: 2023" min="2000" max="2035">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-semibold">Spesifikasi</label>
                            <textarea name="spesifikasi" class="form-control rounded-3" rows="3" placeholder="Contoh: Intel Core i7, RAM 16GB..."></textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-semibold">Deskripsi</label>
                            <textarea name="deskripsi" class="form-control rounded-3" rows="2" placeholder="Deskripsi lengkap perangkat..."></textarea>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="editBarangModal{{ $item->id }}" tabindex="-1" aria-labelledby="editBarangModalLabel{{ $item->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            <form method="POST" action="{{ route('admin.barang.update', $item->id) }}">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Merk</label>
                            <input type="text" name="merk" class="form-control rounded-3" value="{{ $item->merk ?? '' }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Lokasi Rak</label>
                            <input type="text" name="lokasi_rak" class="form-control rounded-3" value="{{ $item->lokasi_rak ?? '' }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Tahun Perolehan</label>
                            <input type="number" name="tahun_perolehan" class="form-control rounded-3" value="{{ $item->tahun_perolehan ?? '' }}">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-semibold">Spesifikasi</label>
...
{{-- JAVASCRIPT UNTUK MODAL ERROR --}}
@if($errors->any())
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Jika ada error, buka modal tambah
        var modal = new bootstrap.Modal(document.getElementById('addBarangModal'));
        modal.show();
    });
</script>
@endif
...
<style>
    ...
    /* Perbaikan untuk modal agar input bisa diklik */
    .modal-body {
        position: relative;
        z-index: 1;
    }
